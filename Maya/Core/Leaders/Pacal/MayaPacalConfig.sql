...
INSERT INTO PlayerItems	
		(CivilizationType,				LeaderType,					Type,						Icon,							Name,									Description,									SortIndex)
SELECT	'CIVILIZATION_RELIC_ENIG_MAYA',		'LEADER_RELIC_ENIG_PAKAL',	'PROJECT_RELIC_ENIG_VENUS',	'ICON_PROJECT_RELIC_ENIG_VENUS',	'LOC_PROJECT_RELIC_ENIG_VENUS_NAME',		'LOC_PROJECT_RELIC_ENIG_VENUS_DESCRIPTION',		30
WHERE EXISTS (SELECT * FROM RELIC_ENIG_GlobalUserSettings WHERE Type = 'RELIC_ENIG_MAYA_PAKAL' AND Value = 1);	
-------------------------------------
-- MapSupportedValues
-------------------------------------	
