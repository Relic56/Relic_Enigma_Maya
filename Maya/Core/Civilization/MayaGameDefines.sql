...
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT', 		'MOMENT_DATA_UNIT',			'UNIT_RELIC_ENIG_MACUAHUITL',		'Moment_UniqueUnit_Rel_Hadzab.dds'),
		('MOMENT_ILLUSTRATION_UNIQUE_DISTRICT', 	'MOMENT_DATA_DISTRICT',		'DISTRICT_RELIC_ENIG_CARACOL',		'Moment_UniqueInfrastructure_Rel_Caracol.dds');
--==========================================================================================================================
...
VALUES	('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_PALENQUE'),	
		...
		('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_QUMARKAJ'),	
		...
		('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_YOKIB'),	
		('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_TULUUM'),	
		...
		('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_CHEN_CHUN_CHUKUM'),	
		...
		('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_SAAAL'),	
