...
VALUES	('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_PALENQUE'),	
	...
	('CIVILIZATION_RELIC_ENIG_MAYA',			'LOC_CITY_NAME_MAYA_KOBA'),	
...
VALUES			("LOC_CITY_NAME_MAYA_PALENQUE",	"en_US",
			...
			"Iximche"),	
			("LOC_CITY_NAME_MAYA_CALAKMUL",	"en_US",
			"Calakmul"),	
			("LOC_CITY_NAME_MAYA_YO'K'IB_",	"en_US",
			"Yo'k'ib "),	
			("LOC_CITY_NAME_MAYA_TULU'M_",	"en_US",
			"Tulu'm "),	
			("LOC_CITY_NAME_MAYA_YAXCHILAN",	"en_US",
			"Yaxchilan"),	
			("LOC_CITY_NAME_MAYA_OXMAL",	"en_US",
			"Oxmal"),	
			("LOC_CITY_NAME_MAYA_DZIBILCHALTUN",	"en_US",
			"Dzibilchaltun"),	
			("LOC_CITY_NAME_MAYA_CH'EN_CHUN_CHUKUM",	"en_US",
			"Ch'en Chun Chukum"),	
			("LOC_CITY_NAME_MAYA_KAMINALJUYU",	"en_US",
			"Kaminaljuyu"),	
			...
			"Quirigua"),	
			("LOC_CITY_NAME_MAYA_BEKAN",	"en_US",
			"Bekan"),	
			("LOC_CITY_NAME_MAYA_YAXHA_",	"en_US",
			"Yaxha "),	
			("LOC_CITY_NAME_MAYA_OXWITZA",	"en_US",
			"Oxwitza"),	
			("LOC_CITY_NAME_MAYA_KOBA",	"en_US",
			"Koba"),	
			("LOC_CITY_NAME_MAYA_DOS_PILAS_",	"en_US",
			"Dos Pilas "),	
			("LOC_CITY_NAME_MAYA_SAN_BARTOLO_",	"en_US",
			"San Bartolo "),	
			("LOC_CITY_NAME_MAYA_WAKA",	"en_US",
			"Waka"),	
			("LOC_CITY_NAME_MAYA_OXKINTOK_",	"en_US",
			"Oxkintok "),	
			("LOC_CITY_NAME_MAYA_SA'AAL_",	"en_US",
			"Sa'aal "),	
			("LOC_CITY_NAME_MAYA_IXKUN_",	"en_US",
			"Ixkun "),	
			("LOC_CITY_NAME_MAYA_EL_BAUL",	"en_US",
			"El Baul"),	
			("LOC_CITY_NAME_MAYA_CEIBAL_",	"en_US",
			"Ceibal "),	
